      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 items-center">
          <div className="flex justify-center">
            <div className="relative h-80 w-80 overflow-visible rounded-full border-4 border-primary transition-all duration-500 ease-in-out transform hover:scale-[2.5] hover:rotate-3 hover:shadow-2xl hover:shadow-primary/30 hover:border-primary/80 perspective-1000 z-10">
